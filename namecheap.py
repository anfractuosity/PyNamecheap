...
class Api(object):
    ...
    def domains_dns_setDefault(self, domain):
        ...
        sld = ex.domain
        tld = ex.suffix
        self._call("namecheap.domains.dns.setDefault", {"SLD": sld, "TLD": tld})
    ...
    def domains_getContacts(self, DomainName):
        ...
        for contact_type in xml.findall(xpath):
            ...
            for contact_detail in contact_type.findall("*"):
                fields_for_one_contact_type[
                    self._tag_without_namespace(contact_detail)
                ] = contact_detail.text
            results[
                self._tag_without_namespace(contact_type)
            ] = fields_for_one_contact_type
        return results
    ...
    def domains_getList(
        self, ListType=None, SearchTerm=None, PageSize=None, SortBy=None
    ):
